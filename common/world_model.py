...
from common import layers, math, init, scale
...
class WorldModel(nn.Module):
	...
	def __init__(self, cfg):
		...
		self._harmony_consistency = scale.Harmonizer(cfg.harmony)
		self._harmony_reward = scale.Harmonizer(cfg.harmony)
		self._harmony_termination = scale.Harmonizer(cfg.harmony)
		self._harmony_value = scale.Harmonizer(cfg.harmony)
